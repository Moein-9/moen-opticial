...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    errorFetchingLensData: 'Error fetching lens data',
    tryRefreshingPage: 'Please try refreshing the page.',
    framesAvailable: 'frames available',
    printLabel: 'Print label',
    incorrectAdminPassword: 'Incorrect admin password. Ask your manager.',
    frameDeletedSuccessfully: 'Frame deleted',
    errorDeletingFrame: 'Error deleting frame',
    patientNotes: 'Customer notes',
    noNotesYet: 'No notes yet',
    addNoteBelow: 'Add a note using the field below.',
    addNoteHere: 'Write a note here...',
    addNote: 'Add note',
    ...
    noOutstandingBalances: 'Every invoice is fully paid. Great work keeping things in order.',
    searchClientOrInvoice: 'Search by client, phone or invoice',
    sortBy: 'Sort by',
    newestFirst: 'Newest first',
    oldestFirst: 'Oldest first',
    errorLoadingInvoices: 'Unable to load outstanding invoices',
    loading: 'Loading',
    ...
    recordPaymentFor: 'Record payment for invoice',
    cancelAction: 'Cancel',
    ...
    // Transactions table — print choice dialog
    printWhat: "What would you like to print?",
    printWhatDesc: "Choose a document to print for this customer.",
    printRx: "Prescription",
    printRxDesc: "Eye exam RX receipt (80mm)",
    printInvoiceShort: "Invoice",
    printInvoiceShortDesc: "Customer payment receipt",
    printWorkOrderShort: "Work Order",
    printWorkOrderShortDesc: "Lab production sheet",
    noRxAvailable: "No prescription on file for this customer",
    noWorkOrderAvailable: "No work order linked to this invoice",
    searchTransactions: "Search by name, phone, or invoice number...",
    profile: "Profile",
    print: "Print",
    customer: "Customer",
  },
  ar: {
    ...
    errorFetchingLensData: 'حدث خطأ أثناء جلب بيانات العدسات',
    tryRefreshingPage: 'يرجى إعادة تحميل الصفحة والمحاولة مرة أخرى.',
    framesAvailable: 'إطار متوفر',
    printLabel: 'طباعة الملصق',
    incorrectAdminPassword: 'كلمة مرور المدير غير صحيحة. يُرجى طلبها من المدير.',
    frameDeletedSuccessfully: 'تم حذف الإطار',
    errorDeletingFrame: 'حدث خطأ أثناء حذف الإطار',
    patientNotes: 'ملاحظات العميل',
    noNotesYet: 'لا توجد ملاحظات بعد',
    addNoteBelow: 'يمكنك إضافة ملاحظة من خلال الحقل أدناه.',
    addNoteHere: 'اكتب ملاحظة هنا...',
    ...
    makePayment: 'تسديد الدفعة',
    paymentAmount: 'مبلغ الدفع',
    process: 'معالجة',
    remainingAmount: 'متبقي',
    viewInvoice: 'عرض الفاتورة',
    clientFile: 'ملف العميل',
    allPaymentsCollected: 'تم تحصيل جميع المدفوعات',
    noOutstandingBalances: 'جميع الفواتير مدفوعة بالكامل. عمل رائع في إدارة المبالغ.',
    searchClientOrInvoice: 'ابحث باسم العميل أو رقم الهاتف أو الفاتورة',
    sortBy: 'ترتيب حسب',
    newestFirst: 'الأحدث أولاً',
    oldestFirst: 'الأقدم أولاً',
    errorLoadingInvoices: 'تعذر تحميل الفواتير المستحقة',
    loading: 'جارٍ التحميل',
    invoicesOutstanding: 'فواتير مستحقة',
    invoiceOutstanding: 'فاتورة مستحقة',
    totalOwed: 'إجمالي المستحق',
    paidSoFar: 'المدفوع حتى الآن',
    invoiceTotal: 'إجمالي الفاتورة',
    paymentHistory: 'سجل الدفعات',
    glassesDetails: 'تفاصيل النظارة',
    lensTypeLabel: 'نوع العدسة',
    frameLabel: 'الإطار',
    coatingLabel: 'الطلاء',
    ...
    recordPaymentFor: 'تسجيل دفعة للفاتورة',
    cancelAction: 'إلغاء',
    ...
    // Transactions table — print choice dialog
    printWhat: "ماذا تريد أن تطبع؟",
    printWhatDesc: "اختر المستند الذي تريد طباعته لهذا العميل.",
    printRx: "الوصفة الطبية",
    printRxDesc: "إيصال وصفة فحص النظر (80mm)",
    printInvoiceShort: "الفاتورة",
    printInvoiceShortDesc: "إيصال دفع العميل",
    printWorkOrderShort: "أمر العمل",
    printWorkOrderShortDesc: "ورقة الإنتاج للمختبر",
    noRxAvailable: "لا توجد وصفة مسجلة لهذا العميل",
    noWorkOrderAvailable: "لا يوجد أمر عمل مرتبط بهذه الفاتورة",
    searchTransactions: "ابحث بالاسم أو الهاتف أو رقم الفاتورة...",
    profile: "الملف",
    print: "طباعة",
    customer: "العميل",
  }
